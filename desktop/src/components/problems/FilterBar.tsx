            ...
            <div className="flex items-center gap-1 shrink-0">
              {selectedTag && (
                <button
                  ...
                  className="text-muted-foreground hover:text-foreground z-10 cursor-pointer p-0.5 rounded hover:bg-muted transition-colors flex items-center justify-center"
